...
file_dir=/container_data/processed_data
cd /usr/src/imoco_recon/imoco_py
python3 convert_uwute.py \${file_dir}/MRI_Raw
python3 recon_xdgrasp.py \${file_dir}/MRI_Raw
python3 recon_imoco.py \${file_dir}/MRI_Raw --reg_flag 1 --device 0
python3 dicom_creation.py \${file_dir}
"